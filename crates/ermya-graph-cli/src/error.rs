...
impl From<ermya_graph_protocol::ProtocolError> for CliError {
    fn from(e: ermya_graph_protocol::ProtocolError) -> Self {
...
mod tests {
    ...
    fn from_protocol_error() {
        let pe = ermya_graph_protocol::ProtocolError::BoltInvalidHandshake { reason: "test" };
