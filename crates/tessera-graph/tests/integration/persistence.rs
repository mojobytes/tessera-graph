...
use tessera_graph::{Graph, GraphConfig, Property, props};
...
fn assert_str_prop(props: &tessera_graph::Properties, key: &str, expected: &str) {
    match props.get(key) {
...
fn assert_i64_prop(props: &tessera_graph::Properties, key: &str, expected: i64) {
    match props.get(key) {
