...
//! nodes.
//!
//! Three shapes, mirroring tessera's two graphs plus a dense contrast:
//!
...
//! - `perms`: tessera's authz perf test — 3 subjects granted over N resource
...
//!   --example issue54_thrashing -p tessera-graph
//! ```
//!
...
///
/// Mirrors tessera's authz perf test: 3 subjects granted over 100k vectors with
