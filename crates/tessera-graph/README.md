...
infrastructure. `tessera-graph` is a library you link into your process: it
...
[docs.rs](https://docs.rs/tessera-graph) for the exact signatures.

## When to reach for it

Use `tessera-graph` when you want graph storage and Cypher *inside* your
...
authorization), those live in the TesseraGraph server editions, not in this
crate.
