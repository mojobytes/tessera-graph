...
use tessera_graph_auth::error::AuthError;
use tessera_graph_auth::providers::ExternalAuthProvider;
use tessera_graph_auth::providers::group_mapping::map_groups;
...
mod tests {
    use super::*;
    use tessera_graph_auth::providers::ExternalUserInfo;
    ...
    impl ExternalAuthProvider for AlwaysOkProvider {
        fn authenticate(
            ...
            Box<
                dyn std::future::Future<Output = tessera_graph_auth::Result<ExternalUserInfo>>
                    + Send
                    + '_,
            >,
        > {
