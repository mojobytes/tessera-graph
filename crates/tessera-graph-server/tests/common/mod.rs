...
use tessera_graph_auth::rate_limit::LoginPolicy;
use tessera_graph_auth::rbac::{RoleStore, RoleStoreHandle};
...
use tessera_graph_server::BoltConnectionHandler;
use tessera_graph_server::context::ServerContext;
use tessera_graph_tenant::TenantRegistry;
use tokio::io::{AsyncReadExt, AsyncWriteExt};

#[allow(dead_code)]
pub fn test_tls_config() -> tessera_graph_protocol::TlsConfig {
    ...
    tessera_graph_protocol::tls::TlsConfigBuilder::new()
        .cert_file(cert_path)
        .key_file(key_path)
        .build()
        .unwrap()
