...
impl From<tessera_protocol::ProtocolError> for CliError {
    fn from(e: tessera_protocol::ProtocolError) -> Self {
...
mod tests {
    ...
    fn from_protocol_error() {
        let pe = tessera_protocol::ProtocolError::FrameTooLarge { declared: 999 };
