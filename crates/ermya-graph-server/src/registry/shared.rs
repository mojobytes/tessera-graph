...
pub(crate) fn open_graph_with_mvcc(
    ...
    quota: Option<ermya_graph::QuotaHook>,
    limits: EngineLimits,
    wal_observer: ermya_graph::WalObserver,
) -> std::result::Result<Graph, ermya_graph::Error> {
...
/// panics, so a misconfigured `ERMYA_REGISTRY_SWEEP_INTERVAL_SECONDS=0`
